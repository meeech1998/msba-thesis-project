...
# Color-blind-safe palette (Tableau)
...
ax.scatter(top_months["month_start"], top_months["encounters"], s=60, zorder=3, color=HIGHLIGHT_COLOR)
...
ax.scatter([peak_severity["month_start"]], [peak_severity["severe_rate"]], s=60, zorder=3, color=HIGHLIGHT_COLOR)
annotate_peak(
    ax,
...
ax.scatter([peak_repeat["month_start"]], [peak_repeat["repeat_rate"]], s=60, zorder=3, color=HIGHLIGHT_COLOR)
annotate_peak(
    ax,
